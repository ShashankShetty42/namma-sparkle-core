...
const storyCards: LessonCard[] = [
  ...
  { id: "c1", kind: "concept", phase: "Concept", tone: "challenge", character: { name: "Dev", image: devThinking },
    ...
    pillars: [
      { tone: "story", icon: "eye", title: "See", body: "Looks at lots of examples" },
      { tone: "challenge", icon: "brain", title: "Spot patterns", body: "Notices what repeats" },
      { tone: "bonus", icon: "sparkles", title: "Predict", body: "Guesses the next answer" },
    ] },
  { id: "e1", kind: "examples", phase: "Examples", tone: "explore", character: { name: "Neo", image: neoHappy },
    ...
    items: [
      { tone: "explore", icon: "camera", title: "Camera filters", body: "Finds your face in real time" },
      { tone: "bonus", icon: "mic", title: "Voice assistants", body: "Siri & Alexa understand you" },
      { tone: "story", icon: "sparkles", title: "Recommendations", body: "YouTube picks the next video" },
      { tone: "challenge", icon: "map", title: "Smart maps", body: "Predict traffic instantly" },
    ] },
...
const exploreCards: LessonCard[] = [
  ...
  { id: "es2", kind: "concept", phase: "Concept", tone: "explore", character: { name: "Dev", image: devExplaining },
    ...
    pillars: [
      { tone: "explore", icon: "eye", title: "It watches", body: "Listens, sees, reads inputs" },
      { tone: "story", icon: "brain", title: "It learns", body: "Improves the more it sees" },
      { tone: "success", icon: "wand", title: "It acts", body: "Suggests, picks, predicts" },
    ] },
  { id: "esp1", kind: "spot", phase: "Spot", tone: "explore", character: { name: "Neo", image: neoThinking },
    ...
    examples: [
      { tone: "explore", icon: "map", title: "Smart maps", body: "Google Maps suggests the fastest route" },
      { tone: "story", icon: "sparkles", title: "Video feed", body: "YouTube recommends videos I like" },
      { tone: "bonus", icon: "camera", title: "Face unlock", body: "My phone unlocks with my face" },
      { tone: "success", icon: "music", title: "Music for me", body: "Spotify makes a playlist that fits my mood" },
    ] },
...
const writeCards: LessonCard[] = [
  ...
  { id: "wc1", kind: "concept", phase: "Concept", tone: "reflect", character: { name: "Anaya", image: anayaThinking },
    ...
    pillars: [
      { tone: "reflect", icon: "heart", title: "Care", body: "Pick something you love" },
      { tone: "story", icon: "lightbulb", title: "Imagine", body: "Picture it clearly" },
      { tone: "bonus", icon: "sparkles", title: "Share", body: "Tell us in your voice" },
    ] },
